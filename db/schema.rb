...
ActiveRecord::Schema.define(version: 20170315140106) do
  ...
  create_table "games_users", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "name",                   default: "", null: false
    t.string   "gamer_tag",              default: "", null: false
